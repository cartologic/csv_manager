    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lon_field_name', models.CharField(max_length=55, validators=[csv_manager.models.valid_table_column_name])),
                ('lat_field_name', models.CharField(max_length=55, validators=[csv_manager.models.valid_table_column_name])),
                ('wkt_field_name', models.CharField(max_length=55, validators=[csv_manager.models.valid_table_column_name])),
